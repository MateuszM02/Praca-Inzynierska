...
: MergeTestStruct<Points1::Point2D>(
    path,
    std::make_shared<Points1::Points>(f), 
    expectedResult)
{ }
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        PointsArgs(
            ...
            PointsFixture::initExpected(PointsFixture::fmod3i3_mod7i64, PointsFixture::f3i_mod9i64, 300000, 200000)),
        PointsArgs(
            Path::Create(MergePoints, 2),
            PointsFixture::initPoints(PointsFixture::fmod3i3_mod7i64, PointsFixture::f3i_mod9i64, 700000, 300000),
            PointsFixture::initExpected(PointsFixture::fmod3i3_mod7i64, PointsFixture::f3i_mod9i64, 700000, 300000)),
        PointsArgs(
            ...
            PointsFixture::initExpected(PointsFixture::fmod3i3_mod7i64, PointsFixture::f3i_mod9i64, 4000000, 1000000))
    ));
